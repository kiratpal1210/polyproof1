...
const ABI = require('../artifacts/contracts/cricket_india.sol/cricket_india.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("cricket_india");
  const nft = await NFT.attach('0xFa53Ef57065567884314Cf017B792ab791892E7a');
